                ...
                <div class="sidebar-wrapper">
                    <nav class="mt-2"> <!--begin::Sidebar Menu-->
                        <ul class="nav sidebar-menu flex-column" role="menu">
                            <li class="nav-item"> <a href="{{ route('infokpsk') }}" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                    <p>Informasi KP</p>
                                </a> </li>
                            <li class="nav-item"> <a href="{{ route('validasi') }}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
